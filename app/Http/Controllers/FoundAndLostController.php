...
class FoundAndLostController extends Controller
{
    public function getAll() {
        ...
        foreach($recovered as $recoveredKey => $recoveredValue) {
            $recovered[$lostKey]['datecreated'] = date('d/m/Y', strtotime($recoveredValue['datecreated']));
            $recovered[$lostKey]['photo'] = asset('storage/' . $recoveredValue['photo']);
        }
