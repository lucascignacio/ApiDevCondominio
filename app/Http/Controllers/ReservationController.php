...
class ReservationController extends Controller
{
    ...
    public function setReservation($id, Request $request) {
        ...
        if(!$validator->fails()) {
            ...
            if($unit && $area) {
                ...
                //Verificar se está dentro do DisableDays
                ...
                if($can) {
                    ...
                    $array['error'] = 'Reserva nõa permitida nesse Dia/Horário';
                }
    ...
    public function getDisabledDates($id) {
        ...
        if($area) {
            ...
            //Listar os dias proibidos +3 meses paa frente
            $start = time();
    ...
    public function deleteMyReservation($id){
        $array = ['error' => ''];
